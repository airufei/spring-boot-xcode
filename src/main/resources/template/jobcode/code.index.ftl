...
<@netCommon.commonScript />
    ...
    <#assign glueTypeModeSrc = "/plugins/codemirror/mode/clike/clike.js" />
    ...
    <#elseif jobInfo.glueType == "GLUE_SHELL" >
        <#assign glueTypeModeSrc = "/plugins/codemirror/mode/shell/shell.js" />
        <#assign glueTypeIdeMode = "text/x-sh" />
    <#elseif jobInfo.glueType == "GLUE_PYTHON" >
        <#assign glueTypeModeSrc = "/plugins/codemirror/mode/python/python.js" />
        <#assign glueTypeIdeMode = "text/x-python" />
    <#elseif jobInfo.glueType == "GLUE_PHP" >
        <#assign glueTypeModeSrc = "/plugins/codemirror/mode/php/php.js" />
        <#assign glueTypeIdeMode = "text/x-php" />
        <#assign glueTypeModeSrc02 = "/plugins/codemirror/mode/clike/clike.js" />
    <#elseif jobInfo.glueType == "GLUE_NODEJS" >
        <#assign glueTypeModeSrc = "/plugins/codemirror/mode/javascript/javascript.js" />
...
<script src="/js/code.index.1.js"></script>
