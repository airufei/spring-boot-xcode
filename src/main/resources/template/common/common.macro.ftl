...
<#-- favicon -->
    ...
    <![endif]-->
     <link rel="stylesheet" href="/treeview/bootstrap-treeview.css">
	<!-- pace -->
...
<script src="/js/user.menu.tree.js"></script>
...
<#macro commonHeader>
	<header class="main-header">
        <a href="${request.contextPath}/" class="logo">
            <span class="logo-mini"><b>X-CODE</b></span>
...
<#macro commonFooter >
	<footer class="main-footer">
        <b>X-CODE</b> ${I18n.admin_version}
        <div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2020-${.now?string('yyyy')} &nbsp;
                <a href="https://www.kafeijie.com" target="_blank">X-CODE</a>
